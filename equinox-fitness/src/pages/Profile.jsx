  ...
  if (!isLoaded || loading) {
    return (
      <div className="pt-44 flex flex-col items-center justify-center">
        ...
        <p className="text-black/40 font-bold uppercase tracking-widest text-[10px]">Imediat...</p>
      </div>
    );
  }
  ...
  return (
    <div className="relative min-h-screen overflow-hidden pb-32">
      <div className="pt-32 md:pt-40 pb-24 max-w-5xl mx-auto px-6">
          ...
          <div className="bg-white rounded-[40px] border border-zinc-200/60 shadow-xl shadow-black/[0.02] p-8 md:p-14 flex flex-col md:flex-row items-center gap-10 relative overflow-hidden">
            ...
            <div className="text-center md:text-left flex-grow relative z-10">
              <div className="inline-flex items-center gap-2 bg-zinc-100 px-3 py-1 rounded-full mb-6">
                ...
                <span className="text-[9px] font-black uppercase tracking-[0.2em] text-black/40">Ești activ</span>
              </div>
              
              <h1 className="text-4xl md:text-6xl font-black tracking-tighter text-black mb-3 leading-none signature-dot">
              ...
              <div className="flex flex-wrap items-center justify-center md:justify-start gap-4 mt-6">
                <div className={`px-5 py-2.5 rounded-2xl border text-[10px] font-black uppercase tracking-[0.2em] shadow-sm ${getTierColor(dbUser?.subscription_tier)}`}>
                  {dbUser?.subscription_tier === 'pro' ? 'Atlet Pro' : 
                   dbUser?.subscription_tier === 'premium' ? 'Membru Premium' : 'Membru de bază'}
                </div>
        ...
        {/* PERFORMANCE METRICS GRID - ASYMMETRIC SPANS */}
        <div className="grid grid-cols-2 md:grid-cols-6 gap-4 mb-12">
          {[
            { label: 'Antrenamente', value: '0', icon: Calendar, color: 'text-blue-500', bg: 'bg-blue-500/5', span: 'md:col-span-2' },
            { label: 'Recorduri', value: '0', icon: Trophy, color: 'text-amber-500', bg: 'bg-amber-500/5', span: 'md:col-span-1' },
            { label: 'Zile Active', value: '0', icon: Zap, color: 'text-purple-500', bg: 'bg-purple-500/5', span: 'md:col-span-1' },
            { label: 'Frecvență', value: '0%', icon: Shield, color: 'text-emerald-500', bg: 'bg-emerald-500/5', span: 'md:col-span-2' },
          ].map((stat, i) => (
            <div 
              key={i} 
              className={`bg-white border border-zinc-200/60 p-6 rounded-[32px] premium-hover performance-stripe ${stat.span}`} 
        ...
        <div className="grid grid-cols-1 md:grid-cols-3 gap-8">
          ...
          <div className="md:col-span-2 space-y-8">
            ...
            <div className="bg-white rounded-[40px] border border-zinc-200/60 p-8 md:p-12 hover:shadow-2xl transition-all duration-500">
              <div className="flex justify-between items-center mb-10">
                <div>
                  <h3 className="text-2xl font-black tracking-tighter mb-1 signature-dot">Abonament</h3>
                  <p className="text-xs text-black/40 font-medium">Cardul tău de membru și detalii acces</p>
                </div>
              ...
              <div className="relative group mb-10">
                ...
                <div className="relative bg-white p-8 rounded-[32px] border border-zinc-200 shadow-xl shadow-black/[0.02] overflow-hidden performance-stripe">
                  <div className="absolute top-0 right-0 w-40 h-40 bg-zinc-50 rounded-full -mr-20 -mt-20 blur-3xl"></div>
                  
                  <div className="flex justify-between items-start mb-14 relative z-10">
                    <div>
                      <p className="text-[10px] font-black uppercase tracking-[0.3em] text-black/20 mb-3">Tip abonament</p>
                      <p className="text-2xl font-black text-black tracking-widest uppercase italic leading-none">
                        {dbUser?.subscription_tier === 'pro' ? 'Atlet Pro' : 
                         dbUser?.subscription_tier === 'premium' ? 'Premium Elite' : 'Membru de bază'}
                      </p>
                    </div>
                  ...
                  <div className="flex justify-between items-end relative z-10">
                    <div>
                      <p className="text-[9px] font-black uppercase tracking-widest text-black/20 mb-1">Membru din</p>
                    ...
                    <div className="text-right">
                      <div className="inline-flex items-center gap-2 px-3 py-1 bg-apple-blue/5 rounded-full border border-apple-blue/10">
                        ...
                        <span className="text-[9px] font-bold text-apple-blue uppercase tracking-widest italic">Atlet verificat</span>
                      </div>
                    </div>
                  </div>
                </div>
              ...
              {dbUser?.subscription_tier === 'free' && isTrialActive && (
                <div className="bg-zinc-50 p-6 rounded-[24px] border border-zinc-200/60 mb-10">
                  <div className="flex justify-between items-center mb-4">
                    <span className="text-[10px] font-black uppercase tracking-widest text-black/40 italic">Zile de probă</span>
              ...
              <Link to="/pricing" className="flex items-center justify-between bg-apple-blue text-white p-6 rounded-[24px] group hover:bg-apple-blue/90 transition-all shadow-xl shadow-apple-blue/20">
                <span className="text-[11px] font-black uppercase tracking-widest ml-2">Schimbă planul</span>
            ...
            <div className="bg-white rounded-[40px] border border-zinc-200/60 p-8 md:p-12 hover:shadow-2xl transition-all duration-500">
              <div className="flex justify-between items-center mb-8">
                <h3 className="text-xl font-black tracking-tighter">Ce ai făcut recent</h3>
                <Award size={20} className="text-purple-500" />
              </div>
              <div className="space-y-4">
                {[
                  { title: 'Cont creat', desc: 'Bun venit la Equinox.', time: 'Recent', icon: Shield, color: 'text-emerald-500', bg: 'bg-emerald-50' },
                  { title: 'Obiectiv setat', desc: 'Te concentrezi pe forță și control.', time: 'Recent', icon: Target, color: 'text-blue-500', bg: 'bg-blue-50' },
                  { title: 'Primul pas', desc: 'Te-ai uitat pe programe.', time: 'Acum', icon: Zap, color: 'text-amber-500', bg: 'bg-amber-50' }
                ].map((item, i) => (
          ...
          <div className="space-y-6">
            <div className="bg-white rounded-[40px] border border-zinc-200/60 p-8 md:p-10 space-y-2">
              <h4 className="text-[10px] font-black uppercase tracking-[0.2em] text-black/30 mb-6 px-2">Setări Cont</h4>
              {[
                { icon: User, label: 'Datele tale', color: 'text-blue-500', bg: 'bg-blue-50' },
                { icon: Settings, label: 'Setări Dashboard', color: 'text-purple-500', bg: 'bg-purple-50' },
              ].map((op, i) => (
